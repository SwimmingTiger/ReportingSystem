<%@ Page Language="C#" AutoEventWireup="true" CodeFile="data_settlement.aspx.cs" Inherits="View_Audit_data_settlement" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:database %>" SelectCommand="SELECT * FROM [data_settlement]"></asp:SqlDataSource>
