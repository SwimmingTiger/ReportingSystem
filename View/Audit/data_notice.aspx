<%@ Page Language="C#" AutoEventWireup="true" CodeFile="data_notice.aspx.cs" Inherits="View_Audit_data_notice" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:database %>" SelectCommand="SELECT * FROM [data_notice]"></asp:SqlDataSource>
